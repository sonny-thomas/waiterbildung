...
from app.models.course import DefaultCourse

OPENAI_API_KEY = settings.OPENAI_API_KEY
llm = ChatOpenAI(model="gpt-4o-mini", temperature=0.7)

# Enable structured output from the LLM
structured_llm = llm.with_structured_output(DefaultCourse)
...
- The 'degree' field can only include 'Master', 'Bachelor', or 'None'.
...
async def generate_course(course_url : str) -> DefaultCourse:
